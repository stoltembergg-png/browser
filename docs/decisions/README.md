...
| ADR-004 | Engine contract | `engine-api` define inicialmente somente o subset mínimo de comandos/eventos/capabilities, sem tipos Servo expostos; extensões exigem ADR próprio. | PR-015/021. |
